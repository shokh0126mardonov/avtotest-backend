...
from .serializers import (
    ...
    GroupIdSerializers,
    GroupUserSerializers,
    SubmitAnswerSerializers,
    ExamSerializers,
)
...
class UserGroupViews(APIView):
    ...
    def post(self, request: Request):
        ...
        return Response(
            {"message": f"User {group.name} ga qo‘shildi"}, 201, content_type="json"
        )
    ...
    def delete(self, request: Request):
        ...
        return Response(
            {"message": f"User {group.name} dan o'chirildi"}, 204, content_type="json"
        )
